      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <FadeIn delay={200}>
          <p className="mt-4 text-text-secondary text-lg leading-relaxed">
            Share your PRs, request features, and connect with other lifters who care about progress over everything else.
          </p>
        </FadeIn>
        <FadeIn delay={300}>
          <a
            ...
            className="inline-flex items-center gap-3 mt-8 px-8 py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold rounded-xl transition-colors"
          >
